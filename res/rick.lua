...
local image_h = 395 --after the image has been loaded
...
return {
	...
	animations = {
		...
		run = { -- 1 2 3 4 5 6
			{ q = q(2,136,44,60), ox = 21, oy = 60 }, --run 1
			{ q = q(48,134,50,62), ox = 25, oy = 61 }, --run 2
			{ q = q(100,134,48,62), ox = 24, oy = 60 }, --run 3
			{ q = q(2,200,42,60), ox = 19, oy = 60 }, --run 4
			{ q = q(46,198,50,61), ox = 25, oy = 61 }, --run 5
			{ q = q(98,198,48,62), ox = 24, oy = 60 }, --run 6
			frame_duration = 0.1
		},
		jumpUp = {
		...
		hurtFace = {
			{ q = q(2,330,45,63), ox = 24, oy = 62, delay = 0.05}, --hf1
