...
function fancy.wheel(y)
	if fancy.visible and overQuad(mo.getX(), mo.getY()) then
		if y < 0 then -- Up:
			if kb.isDown("lctrl") or kb.isDown("rctrl") then
