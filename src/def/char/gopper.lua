...
return {
    ...
    animations = {
        ...
        hurtHighWeak = {
            { q = q(2,195,43,59), ox = 26, oy = 58, delay = f(13) }, --hurt high 1
            { q = q(47,195,38,59), ox = 20, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtHighMedium = {
            { q = q(2,195,43,59), ox = 26, oy = 58, delay = f(21) }, --hurt high 1
            { q = q(47,195,38,59), ox = 20, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtHighStrong = {
            { q = q(2,195,43,59), ox = 26, oy = 58, delay = f(29) }, --hurt high 1
            { q = q(47,195,38,59), ox = 20, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtLowWeak = {
            { q = q(87,197,41,57), ox = 22, oy = 56, delay = f(13) }, --hurt low 1
            { q = q(130,195,39,59), ox = 21, oy = 58 }, --hurt low 2
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(87,197,41,57), ox = 22, oy = 56, delay = f(21) }, --hurt low 1
            { q = q(130,195,39,59), ox = 21, oy = 58 }, --hurt low 2
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(87,197,41,57), ox = 22, oy = 56, delay = f(29) }, --hurt low 1
            { q = q(130,195,39,59), ox = 21, oy = 58 }, --hurt low 2
            delay = f(3)
        },
        fall = {
            { q = q(2,262,56,54), ox = 35, oy = 53, delay = f(20) }, --fall 1
            { q = q(60,274,64,42), ox = 38, oy = 41, delay = f(8) }, --fall 2
            { q = q(126,281,63,35), ox = 36, oy = 34 }, --fall 3
            delay = math.huge
        },
        fallTwistWeak = {
        ...
        thrown = {
            ...
            { q = q(2,262,56,54), ox = 35, oy = 53, rotate = -1.57, rx = 17, ry = -26, delay = f(24) }, --fall 1 (rotated -90°)
            { q = q(126,281,63,35), ox = 36, oy = 34 }, --fall 3
            delay = math.huge
        },
        thrown12h = {
        ...
        thrown10h = {
            { q = q(2,262,56,54), ox = 35, oy = 53 }, --fall 1
            delay = math.huge
        },
        thrown8h = {
            { q = q(2,262,56,54), ox = 35, oy = 53, rotate = -1.57, rx = 35, ry = -26 }, --fall 1 (rotated -90°)
            delay = math.huge
        },
        thrown6h = {
