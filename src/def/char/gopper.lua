...
local comboKick = function(slf, cont)
    slf:checkAndAttack(
        { x = 29, y = 22, width = 26, damage = 9, type = "knockDown", velocity = slf.vel_x, sfx = "air" },
        cont
    )
end
local dashAttack = function(slf, cont)
    slf:checkAndAttack(
    { x = 11, y = 31, width = 30, height = 40, damage = 14, type = "knockDown", velocity = slf.velocityDashFall },
    cont
) end
...
return {
    ...
    animations = {
        ...
        grabbedFrames = {
            ...
            { q = q(42,129,43,62), ox = 28, oy = 61 }, --hurt high 2
            { q = q(2,199,67,43), ox = 36, oy = 42 }, --falling
            { q = q(2,199,67,43), ox = 13, oy = 29, rotate = -1.57, rx = 15, ry = -18 }, --falling
