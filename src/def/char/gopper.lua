...
return {
    ...
    animations = {
        ...
        hurtHighWeak = {
            { q = q(42,129,43,62), ox = 28, oy = 61, delay = f(13) }, --hurt high 2
            { q = q(2,129,38,62), ox = 23, oy = 61 }, --hurt high 1
            delay = f(3)
        },
        hurtHighMedium = {
            { q = q(42,129,43,62), ox = 28, oy = 61, delay = f(21) }, --hurt high 2
            { q = q(2,129,38,62), ox = 23, oy = 61 }, --hurt high 1
            delay = f(3)
        },
        hurtHighStrong = {
            { q = q(42,129,43,62), ox = 28, oy = 61, delay = f(29) }, --hurt high 2
            { q = q(2,129,38,62), ox = 23, oy = 61 }, --hurt high 1
            delay = f(3)
        },
        hurtLowWeak = {
