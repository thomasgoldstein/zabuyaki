...
return {
    ...
    animations = {
        ...
        walk = {
            { q = q(2,77,48,74), ox = 18, oy = 73 }, --walk 1
            { q = q(52,78,48,73), ox = 19, oy = 72 }, --walk 2
            { q = q(102,78,48,73), ox = 19, oy = 72, delay = 0.25 }, --walk 3
            { q = q(152,77,48,74), ox = 19, oy = 73 }, --walk 4
            { q = q(202,78,48,73), ox = 18, oy = 72 }, --walk 5
            { q = q(252,78,49,73), ox = 18, oy = 72, delay = 0.25 }, --walk 6
            loop = true,
            delay = 0.2
        },
        run = {
