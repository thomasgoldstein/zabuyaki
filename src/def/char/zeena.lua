...
return {
    ...
    animations = {
        ...
        duck = {
            { q = q(571,282,39,50), ox = 21, oy = 49 }, --duck
            delay = f(4)
        },
        sideStepUp = {
        ...
        respawn = {
            { q = q(344,203,38,60), ox = 22, oy = 59 }, --jump
            { q = q(571,282,39,50), ox = 21, oy = 49, delay = f(36) }, --duck
            delay = math.huge
        },
        pickUp = {
            { q = q(571,282,39,50), ox = 21, oy = 49 }, --duck
        ...
        combo4 = {
            ...
            { q = q(429,210,66,53), ox = 32, oy = 52, funcCont = comboKick, delay = f(10) }, --jump attack 2 (shifted 9px down)
            { q = q(384,206,43,57), ox = 25, oy = 56, delay = f(7) }, --jump attack 1 (shifted 5px down)
            delay = f(4)
        },
        hurtHighWeak = {
            { q = q(344,274,48,58), ox = 29, oy = 57, delay = f(13) }, --hurt high 1
            { q = q(394,273,44,59), ox = 25, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtHighMedium = {
            { q = q(344,274,48,58), ox = 29, oy = 57, delay = f(21) }, --hurt high 1
            { q = q(394,273,44,59), ox = 25, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtHighStrong = {
            { q = q(344,274,48,58), ox = 29, oy = 57, delay = f(29) }, --hurt high 1
            { q = q(394,273,44,59), ox = 25, oy = 58 }, --hurt high 2
            delay = f(3)
        },
        hurtLowWeak = {
            { q = q(440,276,38,56), ox = 20, oy = 55, delay = f(13) }, --hurt low 1
            { q = q(480,275,34,57), ox = 20, oy = 56 }, --hurt low 2
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(440,276,38,56), ox = 20, oy = 55, delay = f(21) }, --hurt low 1
            { q = q(480,275,34,57), ox = 20, oy = 56 }, --hurt low 2
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(440,276,38,56), ox = 20, oy = 55, delay = f(29) }, --hurt low 1
            { q = q(480,275,34,57), ox = 20, oy = 56 }, --hurt low 2
            delay = f(3)
        },
        fall = {
