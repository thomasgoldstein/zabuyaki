...
return {
    ...
    animations = {
        ...
        hurtHighWeak = {
            { q = q(47,125,48,59), ox = 29, oy = 58, delay = f(13) }, --hurt high 1
            { q = q(2,124,43,60), ox = 25, oy = 59 }, --hurt high 2
            delay = f(3)
        },
        hurtHighMedium = {
            { q = q(47,125,48,59), ox = 29, oy = 58, delay = f(21) }, --hurt high 1
            { q = q(2,124,43,60), ox = 25, oy = 59 }, --hurt high 2
            delay = f(3)
        },
        hurtHighStrong = {
            { q = q(47,125,48,59), ox = 29, oy = 58, delay = f(29) }, --hurt high 1
            { q = q(2,124,43,60), ox = 25, oy = 59 }, --hurt high 2
            delay = f(3)
        },
        hurtLowWeak = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(13) }, --hurt low 1
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 2
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(21) }, --hurt low 1
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 2
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(29) }, --hurt low 1
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 2
            delay = f(3)
        },
        fall = {
        ...
        fallTwistWeak = {
            { q = q(70,421,58,52), ox = 34, oy = 52 }, --fall twist 2
            { q = q(130,421,62,55), ox = 34, oy = 52 }, --fall twist 3
            { q = q(194,420,50,56), ox = 31, oy = 53, delay = f(8) }, --fall twist 4
            { q = q(2,421,66,55), ox = 36, oy = 52, delay = math.huge }, --fall twist 1
            delay = f(7)
        },
        fallTwistStrong = {
            { q = q(2,421,66,55), ox = 36, oy = 52 }, --fall twist 1
            { q = q(70,421,58,52), ox = 34, oy = 52 }, --fall twist 2
            { q = q(130,421,62,55), ox = 34, oy = 52 }, --fall twist 3
            { q = q(194,420,50,56), ox = 31, oy = 53 }, --fall twist 4
            loop = true,
            delay = f(5)
        },
        fallBounce = {
        ...
        grabbedFront = {
            { q = q(2,124,43,60), ox = 25, oy = 59 }, --hurt high 2
            { q = q(47,125,48,59), ox = 29, oy = 58 }, --hurt high 1
            delay = f(2)
        },
        grabbedBack = {
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 2
            { q = q(40,188,39,56), ox = 21, oy = 55 }, --hurt low 1
            delay = f(2)
        },
        thrown = {
        ...
        thrown6h = {
            { q = q(40,188,39,56), ox = 21, oy = 55, flipH = -1, flipV = -1 }, --hurt low 1 (flipped horizontally and vertically)
            delay = math.huge
        },
    }
}
