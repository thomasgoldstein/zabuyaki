...
return {
    ...
    animations = {
        ...
        hurtLowWeak = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(13) }, --hurt low 2
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 1
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(21) }, --hurt low 2
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 1
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(40,188,39,56), ox = 21, oy = 55, delay = f(29) }, --hurt low 2
            { q = q(2,186,36,58), ox = 21, oy = 57 }, --hurt low 1
            delay = f(3)
        },
        fall = {
