...
return {
    ...
    animations = {
        ...
        fall = {
            { q = q(2,214,74,57), ox = 34, oy = 56 }, --falling
            delay = 5
        },
        thrown = {
            --rx = oy / 2, ry = -ox for this rotation
            { q = q(2,214,74,57), ox = 34, oy = 56, rotate = -1.57, rx = 29, ry = -30 }, --falling
            delay = 5
        },
        getup = {
            { q = q(78,238,77,33), ox = 45, oy = 32, delay = 0.2 }, --lying down
            --{ q = q(138,193,55,49), ox = 24, oy = 48 }, --getting up
            --{ q = q(114,71,38,56), ox = 18, oy = 55 }, --duck
            delay = 0.3
        },
        fallen = {
            { q = q(78,238,77,33), ox = 45, oy = 32 }, --lying down
            delay = 65
        },
        hurtHigh = {
