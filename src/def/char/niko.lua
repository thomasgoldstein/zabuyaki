...
local comboKick = function(slf, cont)
    slf:checkAndAttack(
        { x = 29, y = 13, width = 26, damage = 7, velocity = slf.vel_x, sfx = "air" },
        cont
    )
...
local jumpAttack = function(slf, cont)
    slf:checkAndAttack(
        { x = 15, y = 37, width = 22, damage = 14, type = "fall", velocity = slf.vel_x },
        cont
    )
end
...
return {
    ...
    animations = {
        ...
        grabAttack1 = {
            ...
            { q = q(124,594,59,60), ox = 32, oy = 59, func = function(slf) slf:releaseGrabbed() end }, --grab attack 2c
            { q = q(124,594,59,60), ox = 33, oy = 59 }, --grab attack 2c (shifted 1px to the left)
