...
local grabAttack = function(slf, cont)
	...
	slf:checkAndAttack(
		{ left = 8, top = 1, width = 26, height = 12, damage = 9 },
		cont
	)
end
local grabAttackLast = function(slf, cont)
	slf:checkAndAttack(
		{ left = 10, top = 25, width = 26, height = 12, damage = 11,
...
local shoveDown = function(slf, cont)
	slf:checkAndAttack(
		{ left = 18, top = 25, width = 26, height = 12, damage = 15,
        type = "fall", velocity = slf.velocityThrow_x },
		cont
	)
end
...
local comboAttack1 = function(slf, cont)
	slf:checkAndAttack(
		{ left = 26, top = 25, width = 26, height = 12, damage = 7, velocity = slf.vel_x, sfx = "air" },
		cont
	)
...
local comboAttack1Forward = function(slf, cont)
	slf:checkAndAttack(
		{ left = 30, top = 1, width = 26, height = 12, damage = 6, velocity = slf.vel_x, sfx = "air" },
		cont
	)
...
local comboAttack2 = function(slf, cont)
	slf:checkAndAttack(
		{ left = 28, top = 1, width = 30, height = 12, damage = 10, velocity = slf.vel_x, sfx = "air" },
		cont
	)
	slf.cooldownCombo = 0.4
end
local comboAttack3 = function(slf, cont)
	slf:checkAndAttack(
		{ left = 32, top = 25, width = 38, height = 12, damage = 12, velocity = slf.vel_x, sfx = "air" },
		cont
	)
	slf.cooldownCombo = 0.4
end
local comboAttack4 = function(slf, cont)
	slf:checkAndAttack(
		{ left = 28, top = 25, width = 30, height = 12, damage = 14, type = "fall", velocity = slf.velocityFall_x, sfx = "air" },
		cont
	)
end
local comboAttack4NoSfx = function(slf, cont)
	...
	slf:checkAndAttack(
		{ left = 28, top = 25, width = 30, height = 12, damage = 14, type = "fall", velocity = slf.velocityFall_x },
		cont
	)
end
local dashAttack1 = function(slf, cont) slf:checkAndAttack(
	{ left = 8, top = 0, width = 22, height = 12, damage = 17, type = "fall", velocity = slf.velocityDashFall },
	cont
) end
local dashAttack2 = function(slf, cont) slf:checkAndAttack(
	{ left = 12, top = 0, width = 30, height = 12, damage = 17, type = "fall", velocity = slf.velocityDashFall },
	cont
) end
...
local jumpAttackLight = function(slf, cont) slf:checkAndAttack(
	{ left = 12, top = 0, width = 22, height = 12, damage = 8, velocity = slf.vel_x },
	cont
) end
local jumpAttackStraight = function(slf, cont) slf:checkAndAttack(
	{ left = 15, top = 0, width = 25, height = 12, damage = 15, type = "fall", velocity = slf.velocityFall_x },
	cont
) end
local jumpAttackRun = function(slf, cont) slf:checkAndAttack(
	{ left = 25, top = 0, width = 35, height = 12, damage = 6, velocity = slf.vel_x },
	cont
) end
local jumpAttackRunLast = function(slf, cont) slf:checkAndAttack(
	{ left = 25, top = 0, width = 35, height = 12, damage = 8, type = "fall", velocity = slf.vel_x },
	cont
) end
