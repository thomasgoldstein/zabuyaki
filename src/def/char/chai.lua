...
return {
    ...
    animations = {
        ...
        dashAttack = {
            ...
            { q = q(2,722,39,65), ox = 18, oy = 64, func = function(slf) slf.speed_z = slf.jumpSpeed_z * slf.jumpSpeedMultiplier end, funcCont = dashAttack1, delay = 0.03 }, --jump attack forward 1
