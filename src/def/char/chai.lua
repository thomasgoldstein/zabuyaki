...
local jump_forward_attack = function(slf) slf:checkAndAttack(33,0, 25,12, 15, "fall") end
...
return {
	...
	animations = {
		...
		jumpAttackForward = {
			...
			{ q = q(82,722,71,64), ox = 24, oy = 63, funcCont = jump_forward_attack, delay = 5 }, --jaf3
			delay = 0.1
		},
		jumpAttackWeak = {
			{ q = q(2,722,39,65), ox = 22, oy = 64 }, --jaf1
