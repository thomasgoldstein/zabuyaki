...
return {
    ...
    animations = {
        ...
        hurtHighWeak = {
            { q = q(52,335,50,64), ox = 32, oy = 63, delay = f(13) }, --hurt high 2
            { q = q(2,335,48,64), ox = 29, oy = 63 }, --hurt high 1
            delay = f(3)
        },
        hurtHighMedium = {
            { q = q(52,335,50,64), ox = 32, oy = 63, delay = f(21) }, --hurt high 2
            { q = q(2,335,48,64), ox = 29, oy = 63 }, --hurt high 1
            delay = f(3)
        },
        hurtHighStrong = {
            { q = q(52,335,50,64), ox = 32, oy = 63, delay = f(29) }, --hurt high 2
            { q = q(2,335,48,64), ox = 29, oy = 63 }, --hurt high 1
            delay = f(3)
        },
        hurtLowWeak = {
            { q = q(148,338,42,61), ox = 22, oy = 60, delay = f(13) }, --hurt low 2
            { q = q(104,336,42,63), ox = 22, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(148,338,42,61), ox = 22, oy = 60, delay = f(21) }, --hurt low 2
            { q = q(104,336,42,63), ox = 22, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(148,338,42,61), ox = 22, oy = 60, delay = f(29) }, --hurt low 2
            { q = q(104,336,42,63), ox = 22, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        fall = {
        ...
        fallTwistWeak = {
            ...
            { q = q(177,2483,52,59), ox = 32, oy = 63, delay = f(8) }, --fall twist 4
