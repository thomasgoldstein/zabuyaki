...
return {
    ...
    animations = {
        ...
        combo3Down = {
            { q = q(2,1757,40,64), ox = 21, oy = 63, func = function(slf) print("11111"); slf:comboEnd() end, delay = 0.03 }, --dash attack 1
            { q = q(44,1759,39,62), ox = 21, oy = 61, delay = 0.1 }, --dash attack 2
            { q = q(85,1759,54,62), ox = 28, oy = 61, delay = 0.015 }, --dash attack 3
            ...
            { q = q(54,1627,44,63), ox = 15, oy = 62 }, --defensive special 7
            { q = q(54,1627,44,63), ox = 15, oy = 62, delay = 0 }, --defensive special 7
            delay = 0.05
        },
        combo4 = {
