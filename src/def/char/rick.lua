...
return {
    ...
    animations = {
        ...
        stand = {
            { q = q(2,3,44,63), ox = 20, oy = 62 }, --stand 1
            { q = q(48,2,43,64), ox = 20, oy = 63 }, --stand 2
            { q = q(93,3,42,63), ox = 20, oy = 62, delay = f(7) }, --stand 3
            { q = q(137,4,42,62), ox = 19, oy = 61, delay = f(15) }, --stand 4
            loop = true,
            delay = f(11)
        },
        walk = {
