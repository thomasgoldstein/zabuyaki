...
return {
	...
	animations = {
		...
		jump = {
			{ q = q(46,262,44,66), ox = 22, oy = 63, delay = 0.15 }, --jump up
			{ q = q(92,262,44,64), ox = 22, oy = 63 }, --jump up/top
			{ q = q(138,262,45,61), ox = 22, oy = 64, delay = 0.2 }, --jump top
			{ q = q(147,195,44,65), ox = 22, oy = 64 }, --jump down/top
			{ q = q(178,395,44,68), ox = 22, oy = 65, delay = 5 }, --jump down
			delay = 0.03
		},
		respawn = {
			{ q = q(178,395,44,68), ox = 22, oy = 65, delay = 5 }, --jump down
