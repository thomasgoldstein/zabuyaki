...
local grabAttack = function(slf, cont)
	...
	slf:checkAndAttack(
		{ x = 18, y = 1, width = 26, damage = 9 },
		cont
	)
end
local grabAttackLast = function(slf, cont)
	slf:checkAndAttack(
		{ x = 25, y = 25, width = 26, damage = 11,
...
local comboAttack1 = function(slf, cont)
	slf:checkAndAttack(
        { x = 28, y = 25, width = 26, damage = 7, velocity = slf.vel_x, sfx = "air" },
        cont
    )
...
local comboAttack2 = function(slf, cont)
	slf:checkAndAttack(
        { x = 28, y = 25, width = 27, damage = 8, velocity = slf.vel_x, sfx = "air" },
        cont
    )
	slf.cooldownCombo = 0.4
end
local comboAttack3 = function(slf, cont)
	slf:checkAndAttack(
        { x = 28, y = 1, width = 27, damage = 10, velocity = slf.vel_x, sfx = "air" },
        cont
    )
	slf.cooldownCombo = 0.4
end
local comboAttack3Up1 = function(slf, cont)
	slf:checkAndAttack(
        { x = 28, y = 25, width = 27, damage = 4, velocity = slf.vel_x, sfx = "air" },
        cont
    )
	slf.cooldownCombo = 0.4
end
local comboAttack3Up2 = function(slf, cont)
	slf:checkAndAttack(
        { x = 18, y = 25, width = 27, damage = 9, velocity = slf.vel_x },
        cont
    )
	slf.cooldownCombo = 0.4
end
local comboAttack4 = function(slf, cont)
	slf:checkAndAttack(
        { x = 34, y = 25, width = 39, damage = 15, type = "fall", velocity = slf.vel_x, sfx = "air" },
        cont
    )
end
...
local holdAttack2 = function(slf, cont)
	slf:checkAndAttack(
        { x = 24, y = 25, width = 39, damage = 15, type = "fall", velocity = slf.vel_x },
        cont
    )
end
local holdAttack3 = function(slf, cont)
	slf:checkAndAttack(
        { x = 14, y = 25, width = 39, damage = 15, type = "fall", velocity = slf.vel_x },
        cont
    )
end
local dashAttack1 = function(slf, cont) slf:checkAndAttack(
    { x = 20, y = 25, width = 55, damage = 8, velocity = slf.velocityDashFall },
    cont
) end
local dashAttack2 = function(slf, cont) slf:checkAndAttack(
    { x = 20, y = 25, width = 55, damage = 10, type = "fall", velocity = slf.velocityDashFall },
    cont
) end
local jumpAttackForward = function(slf, cont) slf:checkAndAttack(
    { x = 30, y = 25, width = 25, damage = 15, type = "fall", velocity = slf.vel_x },
    cont
) end
 local jumpAttackRun = function(slf, cont) slf:checkAndAttack(
    { x = 30, y = 25, width = 25, damage = 17, type = "fall", velocity = slf.vel_x },
     cont
 ) end
...
local jumpAttackStraight1 = function(slf, cont) slf:checkAndAttack(
    { x = 20, y = 25, width = 25, damage = 7, velocity = slf.vel_x },
    cont
) end
local jumpAttackStraight2 = function(slf, cont) slf:checkAndAttack(
    { x = 20, y = 25, width = 25, damage = 9, type = "fall", velocity = slf.velocityFall_x },
    cont
) end
...
local defensiveSpecial = function(slf, cont) slf:checkAndAttack(
    { x = 11, y = 25, width = 75, damage = 25, type = "fall", velocity = slf.vel_x },
     cont
 ) end
