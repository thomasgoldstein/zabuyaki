...
return {
    ...
    animations = {
        ...
        hurtLowWeak = {
            { q = q(144,331,44,62), ox = 18, oy = 61, delay = f(13) }, --hurt low 2
            { q = q(97,330,45,63), ox = 20, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        hurtLowMedium = {
            { q = q(144,331,44,62), ox = 18, oy = 61, delay = f(21) }, --hurt low 2
            { q = q(97,330,45,63), ox = 20, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        hurtLowStrong = {
            { q = q(144,331,44,62), ox = 18, oy = 61, delay = f(29) }, --hurt low 2
            { q = q(97,330,45,63), ox = 20, oy = 62 }, --hurt low 1
            delay = f(3)
        },
        fall = {
