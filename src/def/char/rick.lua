...
return {
    ...
    animations = {
        ...
        specialOffensive = {
            ...
            { q = q(2,2487,50,61), ox = 12, oy = 60, delay = 0.03 }, --special offensive 5
            { q = q(54,2489,41,59), ox = 13, oy = 58 }, --special offensive 6a
            { q = q(97,2490,41,58), ox = 13, oy = 57, delay = 0.25 }, --special offensive 6b
