...
return {
	...
	animations = {
		...
		jumpAttackForward = {
			{ q = q(2,714,54,62), ox = 23, oy = 61, delay = 0.2 }, --jaf1
			{ q = q(58,714,75,58), ox = 33, oy = 57, funcCont = jump_forward_attack }, --jaf2
			delay = 5
		},
		jumpAttackWeak = {
		...
		jumpAttackStill = {
			...
			{ q = q(94,778,43,62), ox = 19, oy = 61, funcCont = jump_still_attack2 }, --jas3
			delay = 5
		},
		sideStepUp = {
