...
PA_SP_DEF_CHAI_R = particles

local dsQuad1 = q(2,36,70,32) -- left frame 1/13
local dsQuad2 = q(74,36,70,32) -- left frame 2/13
local dsQuad3 = q(146,36,70,32) -- left frame 3/13
local dsQuad4 = q(218,36,70,32) -- left frame 4/13
local dsQuad5 = q(290,36,70,32) -- left frame 5/13
local dsQuad6 = q(362,36,70,32) -- left frame 6/13
local dsQuad7 = q(434,36,70,32) -- left frame 7/13
local dsQuad8 = q(506,36,70,32) -- left frame 8/13
local dsQuad9 = q(578,36,70,32) -- left frame 9/13
local dsQuad10 = q(650,36,70,32) -- left frame 10/13
local dsQuad11 = q(722,36,70,32) -- left frame 11/13
local dsQuad12 = q(794,36,70,32) -- left frame 12/13
local dsQuad13 = q(866,36,70,32) -- left frame 13/13

particles = PA_SP_DEF_CHAI_R:clone()
particles:setQuads(dsQuad1, dsQuad2, dsQuad3, dsQuad4, dsQuad5, dsQuad6, dsQuad7, dsQuad8, dsQuad9, dsQuad10, dsQuad11, dsQuad12, dsQuad13)
PA_SP_DEF_CHAI_L = particles
