...
local function swapColors(original_colors, alternative_colors)
    local shader = love.graphics.newShader(sh_swap_colors)
    shader:send("n", #alternative_colors)
    alternative_colors[#alternative_colors+1] = {} --TODO: Remove on fix of Love2D 0.10.2 shaders send bug
    original_colors[#original_colors+1] = {} --Love2D 0.10.2 shaders send bug workaround
    shader:sendColor("colors", unpack(original_colors))
    shader:sendColor("newColors", unpack(alternative_colors))
    alternative_colors[#alternative_colors] = nil --Love2D 0.10.2 shaders send bug workaround
    original_colors[#original_colors] = nil --Love2D 0.10.2 shaders send bug workaround
    return shader
end
...
local rick_colors_2 = {
    ...
    { 37, 90, 147, 255 }, { 23, 56, 92, 255 }, { 10, 25, 41, 255 } } -- blue shoe stripes
local rick_colors_3 = {
...
local niko_colors_original = gopper_colors_original
...
local satoff_colors_4 = {
    ...
    { 239, 179, 161, 255 }} -- no face scar
-- Obstacles
local trashcan_colors_original = {
...
function reloadShaders()
    --print("reloadShaders")
    shaders.rick[1] = swapColors(rick_colors_original, rick_colors_2)
    shaders.rick[2] = swapColors(rick_colors_original, rick_colors_3)
    shaders.chai[1] = swapColors(chai_colors_original, chai_colors_2)
    shaders.chai[2] = swapColors(chai_colors_original, chai_colors_3)
    shaders.kisa[1] = swapColors(kisa_colors_original, kisa_colors_2)
    shaders.kisa[2] = swapColors(kisa_colors_original, kisa_colors_3)
    shaders.gopper[1] = swapColors(gopper_colors_original, gopper_colors_2)
    shaders.gopper[2] = swapColors(gopper_colors_original, gopper_colors_3)
    shaders.gopper[3] = swapColors(gopper_colors_original, gopper_colors_4)
    shaders.gopper[4] = swapColors(gopper_colors_original, gopper_colors_5)
    shaders.niko[1] = swapColors(niko_colors_original, niko_colors_2)
    shaders.niko[2] = swapColors(niko_colors_original, niko_colors_3)
    shaders.sveta[1] = swapColors(sveta_colors_original, sveta_colors_2)
    shaders.zeena[1] = swapColors(zeena_colors_original, zeena_colors_2)
    shaders.beatnick[1] = nil
    shaders.satoff[1] = swapColors(satoff_colors_original, satoff_colors_2)
    shaders.satoff[2] = swapColors(satoff_colors_original, satoff_colors_3)
    shaders.satoff[3] = swapColors(satoff_colors_original, satoff_colors_4)
    shaders.trashcan[1] = swapColors(trashcan_colors_original, trashcan_colors_2)
    shaders.trashcan_particle_color[0] = {118,109,100, 255 }
    shaders.trashcan_particle_color[1] = {87, 116, 130, 255}
end
--reloadShaders()
