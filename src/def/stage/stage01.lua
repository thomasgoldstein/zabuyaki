...
--        {startX = 1800, endX = 2000, startY = 430+20, endY = 430}
    ...
    self.background:add(bgRoad, qRoad, 0 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 1 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 2 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 3 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 4 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 5 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 6 * 360 - 2, 430)
    self.background:add(bgRoad, qRoad, 7 * 360 - 2, 430)
