...
function Niko:initAttributes()
    ...
    self.comboSlideDiagonalSpeed_x = 150 --diagonal horizontal speed of combo3Forward attacks
    self.comboSlideDiagonalSpeed_y = 50 --diagonal vertical speed of combo3Forward attacks
