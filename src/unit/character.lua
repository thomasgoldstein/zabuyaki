...
Character.statesForCharging =     { stand = true, walk = true, duck = true, land = true, sideStep = true, chargeDash = true, hurt = true }
Character.statesForChargeAttack = { stand = true, walk = true, chargeDash = true }
