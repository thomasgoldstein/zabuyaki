...
Character.statesForSpecialDefensive = { stand = true, combo = true, duck2jump = true, walk = true, hurt = true, chargeDash = true, grabbedFront = true, grabbedBack = true, grabFrontAttack = true, grab = true }
    ...
    elseif type == "check" then
        for other, separatingVector in pairs(stage.world:collisions(a)) do
            ...
            if not o:isInvincible()
                and o ~= self
                and CheckLinearCollision(o.z + o:getHurtBoxY() - o:getHurtBoxHeight(), o:getHurtBoxHeight(), self.z + y - h / 2, h)
            then
                items[#items+1] = { o }
            end
        end
