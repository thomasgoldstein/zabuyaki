...
function testState:enter()
    ...
    background:add(bgImg, quadCloud02, 0 + 402 * 5, 50, 0, 0, -6, 0)
    background:add(bgImg, quadCloud02, 0 + 402 * 6, 50, 0, 0, -6, 0)
    background:add(bgImg, quadCloud02, 0 + 402 * 7, 50, 0, 0, -6, 0)
    background:add(bgImg, quadCloud02, 0 + 402 * 8, 50, 0, 0, -6, 0)
    background:add(bgImg, quadCloud02, 0 + 402 * 9, 50, 0, 0, -6, 0)
